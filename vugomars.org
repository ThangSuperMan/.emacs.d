...
- [[#basic-configuration][Basic Configuration]]
  ...
  - [[#a-better-custom-variable-setter][A better custom variable setter]]
- [[#custom-elisp][Custom Elisp]]
  ...
  - [[#extend-add-to-list][Extend ~add-to-list~]]
  - [[#scroll-page][Scroll page]]
  - [[#switch-to-previous-buffer][Switch to previous buffer]]
  - [[#move-to-beginning-of-live][Move to beginning of live]]
  - [[#go-to-match-paren][Go to match paren]]
  - [[#delete-this-file][Delete This File]]
  - [[#kill-all-the-buffer][Kill all the buffer]]
- [[#keybinding-management][Keybinding Management]]
  - [[#which-key][Which-key]]
  - [[#general][General]]
  - [[#evil][Evil]]
  - [[#hydra][Hydra]]
- [[#function-decleration][Function Decleration]]
  - [[#kill-other-buffer][Kill Other Buffer]]
- [[#org-mode][Org-mode]]
- [[#packages-configuration][Packages Configuration]]
  - [[#autocompletion][Autocompletion]]
  - [[#applications][Applications]]
  - [[#editing][Editing]]
  - [[#emacs-built-ins][Emacs built-ins]]
...
**** Appwrite
[[https://appwrite.io][Appwrite]] is an open-source and self-hostable alternative to Firebase. I am currently working on a server SDK for Appwrite in Emacs, so here it is.
#+begin_src emacs-lisp
...
** Org Roam
A couple of keybinds are hidden from roam mode, They are prefixed with ~n~.
#+name: keybinds-roam
| Key | Function                          | Description |
|-----+-----------------------------------+-------------|
|     |                                   | quit        |
...
| fr  | org-roam-dailies-find-tomorrow    |             |
| g   | org-roam-graph                    |             |
